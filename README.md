...
Agent that reviews pull requests and summarizes risky changes.

## Solved Problem

This project demonstrates a practical portfolio implementation for agent that reviews pull requests and summarizes risky changes.
...
- feat: add validation rules for risk scoring
- feat: add reporting view for review comments
